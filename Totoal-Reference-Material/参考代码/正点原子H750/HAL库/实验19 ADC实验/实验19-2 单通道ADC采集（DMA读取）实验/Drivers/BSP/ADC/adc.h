...
#define ADC_ADCX_DMASx_IS_TC()              ( __HAL_DMA_GET_FLAG(&g_dma_adc_handle, DMA_FLAG_TCIF3_7) )   /* 获取DMA1 Stream7传输完成标志位，
                                                                                                           * 这是一个假函数形式，不能当函数使用
                                                                                                           */

#define ADC_ADCX_DMASx_CLR_TC()             do{ __HAL_DMA_CLEAR_FLAG(&g_dma_adc_handle, DMA_FLAG_TCIF3_7); }while(0)  /* 清除DMA1 Stream7传输完成标志位 */
