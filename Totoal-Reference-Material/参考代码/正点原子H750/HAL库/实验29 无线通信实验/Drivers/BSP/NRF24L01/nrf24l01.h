...
#define NRF24L01_CE_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */

#define NRF24L01_CSN_GPIO_PORT             GPIOE
#define NRF24L01_CSN_GPIO_PIN              GPIO_PIN_0
#define NRF24L01_CSN_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PE口时钟使能 */

#define NRF24L01_IRQ_GPIO_PORT             GPIOC
#define NRF24L01_IRQ_GPIO_PIN              GPIO_PIN_3
#define NRF24L01_IRQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOC_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */
