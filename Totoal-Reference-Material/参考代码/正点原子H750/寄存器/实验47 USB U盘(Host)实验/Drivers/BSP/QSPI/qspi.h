...
#define QSPI_BK1_IO0_GPIO_PIN           SYS_GPIO_PIN11
#define QSPI_BK1_IO0_GPIO_AF            9
#define QSPI_BK1_IO0_GPIO_CLK_ENABLE()  do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* PD口时钟使能 */

#define QSPI_BK1_IO1_GPIO_PORT          GPIOD
#define QSPI_BK1_IO1_GPIO_PIN           SYS_GPIO_PIN12
#define QSPI_BK1_IO1_GPIO_AF            9
#define QSPI_BK1_IO1_GPIO_CLK_ENABLE()  do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* PD口时钟使能 */

#define QSPI_BK1_IO2_GPIO_PORT          GPIOD
#define QSPI_BK1_IO2_GPIO_PIN           SYS_GPIO_PIN13
#define QSPI_BK1_IO2_GPIO_AF            9
#define QSPI_BK1_IO2_GPIO_CLK_ENABLE()  do{ RCC->AHB4ENR |= 1 << 3; }while(0)   /* PD口时钟使能 */

#define QSPI_BK1_IO3_GPIO_PORT          GPIOE
#define QSPI_BK1_IO3_GPIO_PIN           SYS_GPIO_PIN2
#define QSPI_BK1_IO3_GPIO_AF            9
#define QSPI_BK1_IO3_GPIO_CLK_ENABLE()  do{ RCC->AHB4ENR |= 1 << 4; }while(0)   /* PE口时钟使能 */
