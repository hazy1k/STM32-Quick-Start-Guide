...
static void oled_data_out(uint8_t data)
{
    ...
    sys_gpio_pin_set(GPIOD, SYS_GPIO_PIN3, data >> 5);  /* D5 */
    sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN8, data >> 6);  /* D6 */
    sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN9, data >> 7);  /* D7 */ 
}
...
void oled_init(void)
{
    ...
    sys_gpio_set(GPIOA, SYS_GPIO_PIN4 | SYS_GPIO_PIN6 | SYS_GPIO_PIN7 | SYS_GPIO_PIN8 ,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PA4,6,7,8设置 */

    sys_gpio_set(GPIOB, SYS_GPIO_PIN7 | SYS_GPIO_PIN8 | SYS_GPIO_PIN9 | SYS_GPIO_PIN10 | SYS_GPIO_PIN11,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PB7,8,9,10,11设置 */

    sys_gpio_set(GPIOC, SYS_GPIO_PIN4 | SYS_GPIO_PIN6 | SYS_GPIO_PIN7 | SYS_GPIO_PIN8 | SYS_GPIO_PIN9 | SYS_GPIO_PIN11,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PC4,6~9,PC11设置 */
