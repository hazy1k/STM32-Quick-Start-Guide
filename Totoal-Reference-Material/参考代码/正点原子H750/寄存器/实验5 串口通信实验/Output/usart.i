#line 1 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
#line 26 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
#line 1 "..\\..\\Drivers\\./SYSTEM/usart/usart.h"
...
#line 29 "..\\..\\Drivers\\./SYSTEM/usart/usart.h"
#line 30 "..\\..\\Drivers\\./SYSTEM/usart/usart.h"
...
#line 27 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
#line 43 "..\\..\\Drivers\\SYSTEM\\usart\\usart.c"
...
{
    while ((((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->ISR & 0X40) == 0);     

    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->TDR = (uint8_t)ch;             
    return ch;
}
...
void USART1_IRQHandler(void)
{
    ...
    if (((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->ISR & (1 << 5))                
    {
        rxdata = ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->RDR;
        ...
        if ((g_usart_rx_sta & 0x8000) == 0)      
        {
            ...
            else       
            {
                ...
                else
                {
                    ...
                    if (g_usart_rx_sta > (200 - 1))g_usart_rx_sta = 0; 
                }
            }
        }
    }

    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->ICR |= 1 << 3; 
...
void usart_init(uint32_t sclk, uint32_t baudrate)
{
    ...
    do{ ((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB4ENR |= 1 << 0; }while(0);  
    do{ ((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB4ENR |= 1 << 0; }while(0);  
    do{ ((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB2ENR |= 1 << 4; }while(0);       

    sys_gpio_set(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), 1<<9,
                 2, 0, 1, 1); 

    sys_gpio_set(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), 1<<10,
                 2, 0, 1, 1); 

    sys_gpio_af_set(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), 1<<9, 7);    
    sys_gpio_af_set(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), 1<<10, 7);    

    temp = (sclk * 1000000 + baudrate / 2) / baudrate;   
     
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->BRR = temp;        
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 = 0;           
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 0 << 28;    
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 0 << 12;    
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 0 << 15;    
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 1 << 3;     

     
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 1 << 2;     
    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 1 << 5;     
    sys_nvic_init(3, 3, USART1_IRQn, 2);  

    ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->CR1 |= 1 << 0;     
}
