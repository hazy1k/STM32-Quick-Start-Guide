#line 1 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"
...
#line 27 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"
...
#line 28 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"

static uint16_t  g_fac_us = 0;       


 
#line 131 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"
...
void delay_init(uint16_t sysclk)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= 1 << 2;     
    g_fac_us = sysclk;           
#line 154 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"
}


#line 220 "..\\..\\Drivers\\SYSTEM\\delay\\delay.c"
...
{
    uint32_t temp;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = nus * g_fac_us;  
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0x00;             
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= 1 << 0 ;        
