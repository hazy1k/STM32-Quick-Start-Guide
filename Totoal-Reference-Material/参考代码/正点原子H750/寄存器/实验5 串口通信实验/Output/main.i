...
#line 23 "..\\..\\User\\main.c"
#line 1 "..\\..\\Drivers\\./SYSTEM/delay/delay.h"
...
#line 30 "..\\..\\Drivers\\./SYSTEM/delay/delay.h"
...
int main(void)
{
    ...
    while (1)
    {
        if (g_usart_rx_sta & 0x8000)         
        {
            ...
            for (t = 0; t < len; t++)
            {
                ((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL))->TDR = g_usart_rx_buf[t];
        ...
        else
        {
            ...
            if (times % 30  == 0) do{ ((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0400UL))->ODR^=1<<4; }while(0);  
