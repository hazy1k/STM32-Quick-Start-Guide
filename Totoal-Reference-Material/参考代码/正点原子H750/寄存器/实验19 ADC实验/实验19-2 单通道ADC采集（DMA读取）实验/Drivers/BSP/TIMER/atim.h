...
#define ATIM_TIMX_PWMIN_CHY_GPIO_AF             1                           /* AF功能选择 */
#define ATIM_TIMX_PWMIN_CHY_GPIO_CLK_ENABLE()   do{ RCC->AHB4ENR |= 1 << 4; }while(0)   /* PE口时钟使能 */
...
#define ATIM_TIMX_PWMIN_CHY_CLK_ENABLE()        do{ RCC->APB2ENR |= 1 << 0; }while(0)   /* TIMX 时钟使能 */
