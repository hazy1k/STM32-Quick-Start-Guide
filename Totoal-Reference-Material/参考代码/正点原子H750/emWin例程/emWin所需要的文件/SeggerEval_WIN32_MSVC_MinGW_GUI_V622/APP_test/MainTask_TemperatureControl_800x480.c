...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    WM_CreateWindowAsChild(KNOB_X0 + 63, KNOB_Y0 + 63, 75, 75, hItem, WM_CF_SHOW | WM_CF_MEMDEV| WM_CF_HASTRANS, _cbKnobTemperature, 0);
    /*GUI_DrawBitmap(&bmKNOB_175x175, KNOB_X0 + 15, KNOB_Y0 + 15);*/
    //
    ...
    //
    hWin = WM_CreateWindowAsChild(KNOB_X0 , KNOB_Y0, 200, 200, hParent, WM_CF_SHOW| WM_CF_HASTRANS, _cbKnobParent, 0);
    //
    // Create KNOB itself
    //
    KNOB_CreateEx(0, 0, 200, 200, hWin, WM_CF_SHOW | WM_CF_HASTRANS,ID_KNOB_0);
    //
