...
static void _DispLineAA(const char * s, int Len) {
  ...
  if (Len > 0) {
    //
    // Clear if transparency mode has not been selected
    //
...
*
*  Function description
*    Sets the size parameters used to create the cache on the first
*    call of GUI_TTF_CreateFont().
*
*  Parameters
*    MaxFaces: Maximum number of font faces the cache should be able to handle simultaneously.
...
*
*  Function description
*    This function frees all memory allocated by the TTF cache system and destroys
*    the cache.
*
*  Additional information
*    The next time GUI_TTF_CreateFont() is used emWin automatically creates and
...
*
*  Function description
*    This function frees all memory allocated by the TTF engine and its internal
*    cache system.
*
*  Additional information
