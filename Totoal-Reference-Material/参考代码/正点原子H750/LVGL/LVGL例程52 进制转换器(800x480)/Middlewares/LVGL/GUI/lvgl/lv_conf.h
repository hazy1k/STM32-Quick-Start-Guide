...
#define LV_DRAW_COMPLEX                     1
    ...
    /* 增加了错误扩散抖动的支持。
     * 错误扩散抖动得到了更好的视觉效果，但在绘制时意味着更多的CPU和内存消耗。
     * 内存消耗增加(24位*对象的宽度)*/
...
/* 用于通用api的文件系统接口
 * 为该API启用设置驱动程序号 */
#define LV_USE_FS_STDIO                     '\0'        /*使用fopen, fread等*/
//#define LV_FS_STDIO_PATH "/home/john/"    /* 设置工作目录。如果被注释，它将是"./" */

#define LV_USE_FS_POSIX                     '\0'        /* 使用open、read等 */
//#define LV_FS_POSIX_PATH "/home/john/"    /* 设置工作目录。如果被注释，它将是"./" */

#define LV_USE_FS_WIN32                     '\0'        /* 使用CreateFile, ReadFile等 */
//#define LV_FS_WIN32_PATH "C:\\Users\\john\\"    /*设置工作目录。如果加了注释，则为“.\\” */

#define LV_USE_FS_FATFS                     '\0'        /* 使用f_open, f_read等 */
